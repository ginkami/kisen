...
Cache invalidation contract for the admin drawer's tournaments list: tournament mutations (draft creation, save, publish, delete) keep the drawer's month list and title search in sync without a full page reload.
