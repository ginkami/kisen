...
Association entities and their management across the application: the admin drawer "Associations" section, edit routes and forms, service/repository list and search capabilities, and the cascade cleanup of references (tournaments, events, players, regulations) when an association is deleted.
