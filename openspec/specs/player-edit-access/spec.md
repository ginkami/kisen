...
Client-side gating of player edit access: a single shared editability rule mirroring the Firestore player-update rules, filtering of the admin-drawer player search, and a guard against opening an unauthorized player editor via a direct URL.
