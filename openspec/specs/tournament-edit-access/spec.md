...
Client-side gating of tournament edit access: a single shared editability rule mirroring the Firestore tournament-update rules, the service-level editable tournaments listing, the admin drawer's month list and search filtering, and the authentication/access guards on the tournament edit page.
